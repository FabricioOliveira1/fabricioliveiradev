...
export const learningRepos = [
    {
      ...
      },
      {
        id: 5,
        name: 'Flappy Bird',
        description: 'Cópia do jogo Flappy Bird desenvolvido durante Curso Web moderno.',
        languages: ['JavaScript','HTML', 'CSS'],
        githubLink: 'https://github.com/FabricioOliveira1/FlappyBird',
        pageLink: 'https://fabriciooliveira1.github.io/FlappyBird/',
        backImage: 'flappy-bird.png',
      },
      {
        id: 6,
        name: 'Calculadora',
        description: 'Cópia de Calculadora iPhone desenvolvido durante Curso Web moderno.',
